package com.example.test.promotionengine;

import com.example.test.promotionengine.model.Product;
import com.example.test.promotionengine.model.SKU;
import com.example.test.promotionengine.util.PriceCalculator;
...
class PromotionEngineApplicationTests {
    ...
    public void calculateCartPriceTest1(){
        ...
        BigDecimal finalPrice = priceCalculator.calculatePrice(cartItems);
